...
for (const item of coursesAndDurationArray) {
    let course1div = document.createElement('div');

    course1div.innerText = `${item.title} --- ${item.monthDuration}`;
    document.body.append(course1div)
...
for (const item of coursesAndDurationArray2) {
    let course2div = document.createElement('div')
    course2div.classList.add('item')
    document.body.append(course2div)
    let h1 = document.createElement('h1')
    h1.classList.add('heading')
    h1.innerText = `${item.title}`
    course2div.append(h1)
    let p = document.createElement('p')
